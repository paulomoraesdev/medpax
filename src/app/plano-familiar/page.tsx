...
import imageHeader from "@/assets/plano-familiar.png"
      ...
      <div className="font-sans max-w-6xl max-md:max-w-md mx-auto">
        <div className="grid md:grid-cols-2 items-center md:gap-8 gap-6">
          <div className="max-md:order-1 max-md:text-center z-50 relative">
            <h2 className="text-gray-800 lg:text-6xl md:text-5xl text-3xl font-extrabold mb-4 md:!leading-[56px]">Você e sua <span className="text-teal-600">família</span> merecem <span className="text-teal-600">mais</span>!</h2>


            <div className="mt-12">
              <div className="grid sm:grid-cols-3 gap-4 items-center">
                <div className="flex flex-col items-center text-center">
                  <h5 className="text-gray-800 font-bold text-xl mb-2">+1000</h5>
                  <p className="text-gray-600">Associados</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  <h5 className="text-gray-800 font-bold text-xl mb-2">+100</h5>
                  <p className="text-gray-600">Clínicas</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  <h5 className="text-gray-800 font-bold text-xl mb-2">+5000</h5>
                  <p className="text-gray-600">Exames realizados</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:h-[550px] md:h-[550px] flex items-center relative max-md:before:hidden before:absolute before:bg-[#DEE2E5] before:h-[120%] before:w-[120%] before:right-0 before:z-0">
            <Image className="rounded-md lg:w-4/5 z-50 relative" width={ 800 } height={ 800 }  src={imageHeader} alt="" />
          </div>
        </div>

        <div className="grid md:grid-cols-3 gap-4 z-50 relative md:px-4 max-md:mt-12 mb-12">
          <div className="bg-white p-6 shadow rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-11 h-11 mb-4 inline-block bg-lime-100 p-3 rounded-md" viewBox="0 0 32 32">
            ...
            <h3 className="text-gray-800 text-xl font-bold mb-2">Sem carência</h3>
            <p className="text-sm text-gray-600">Comece a usar assim que seu cadastro for confirmado.</p>
          </div>
          <div className="bg-white p-6 shadow rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-11 h-11 mb-4 inline-block bg-lime-100 p-3 rounded-md" viewBox="0 0 512.001 512.001">
            ...
            <h3 className="text-gray-800 text-xl font-bold mb-2">Atendimento</h3>
            <p className="text-sm text-gray-600">Tenha todo o suporte necessário da nossa equipe.</p>
          </div>
          <div className="bg-white p-6 shadow rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-11 h-11 mb-4 inline-block bg-lime-100 p-3 rounded-md" viewBox="0 0 24 24">
            ...
            <h3 className="text-gray-800 text-xl font-bold mb-2">Agilidade</h3>
            <p className="text-sm text-gray-600">Processo rápido e sem burocracia para você utilizar.</p>
          </div>
        </div>
      </div>
      <section className="py-10 bg-teal-600 sm:py-16 lg:py-24 rounded-lg">
        <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
                <div>
                  <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-5xl">Cadastre-se agora e comece a usufruir das vantagens e descontos.</h2>
                  <p className="font-bold text-white text-xs md:max-w-52">* O Plano Medpax é um clube de assinatura e não um plano de saúde.</p>
                </div>
                <div className="">
                    <div className="overflow-hidden bg-white rounded-md">
                        <div className="p-10">
                            <h3 className="text-xs font-semibold tracking-widest text-teal-600 uppercase">Plano mensal</h3>
                            <p className="mt-4 text-3xl font-bold text-black">R$13,20 <small className="text-xs">/família</small></p>
                            ...
                            <ul className="flex flex-col mt-8 space-y-4">
                                <li className="inline-flex items-center space-x-2">
                                    ...
                                    <span className="text-base font-medium text-gray-900"> 5 dependentes gratuitos</span>
                                </li>
                                ...
                                <li className="inline-flex items-center space-x-2">
                                    ...
                                    <span className="text-base font-medium text-gray-900"> + 100 clínicas e laboratórios</span>
                                </li>
                                ...
                                <li className="inline-flex items-center space-x-2">
                                    ...
                                    <span className="text-base font-medium text-gray-900"> Descontos nas empresas parceiras</span>
                                </li>
                            </ul>
                            ...
                            <Link 
                              href="/cadastro" 
                              title="" 
                              className="inline-flex items-center justify-center w-full px-8 py-4 mt-10 font-semibold text-white transition-all duration-200 rounded-full bg-gradient-to-r from-lime-600 to-sky-600 hover:opacity-80 focus:opacity-80" role="button"
                            >
                              Quero aproveitar
                            </Link>
                        </div>
