...
export default function PartnersCard({ partner, identifier }: { partner: any, identifier: any }) {
  return (
    <Link href={ `/parceiros/${ identifier }` } className="whitespace-normal break-words hover:scale-105 transition rounded-lg border border-blue-gray-50 bg-white p-4 font-sans text-sm font-normal text-blue-gray-500 shadow-lg shadow-blue-gray-500/10 focus:outline-none">
