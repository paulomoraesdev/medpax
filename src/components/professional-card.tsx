...
export default function ProfessionalCard({ professional, identifier }: { professional: any, identifier: any }) {
  ...
  const Component = professional.assinante ? Link : 'article'

  return (
    <Component href={ `/profissionais/${ identifier }` } className="whitespace-normal break-words rounded-lg border border-blue-gray-50 bg-white p-4 font-sans text-sm font-normal text-blue-gray-500 shadow-lg shadow-blue-gray-500/10 focus:outline-none">
